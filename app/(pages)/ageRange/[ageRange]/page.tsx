...
const getProducts = async (ageRange: string) => {
    const products = await axios.get(`${process.env.URL}/api/products/ageRange/${ageRange}`)
...
const page = async ({ params }: { params: { ageRange: string } }) => {
    ...
    return (
        <main className='flex flex-1 flex-col'>
            <h1 className='mx-auto text-3xl mt-5 mb-10 font-normal'>{params.ageRange} Years Old</h1>
